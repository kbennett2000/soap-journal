...
> **On a Windows PC or a Mac instead?** This guide is for a dedicated Linux
> server. For a regular Windows or Mac computer, start at the
> [install hub](README.md) and pick your platform — those guides are shorter.
