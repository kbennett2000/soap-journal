...
ALL_BOOKS: tuple[Book, ...] = (
    ...
    _b("Deuteronomy", "Deut", "OT", 5, "Dt", "De"),
    _b("Joshua", "Josh", "OT", 6, "Jos", "Jsh"),
    _b("Judges", "Judg", "OT", 7, "Jdg", "Jgs"),
    _b("Ruth", "Ruth", "OT", 8, "Ru", "Rth"),
    _b("1 Samuel", "1 Sam", "OT", 9, "1Sam", "1 Sm", "1Sm", "First Samuel", "1Sa"),
    _b("2 Samuel", "2 Sam", "OT", 10, "2Sam", "2 Sm", "2Sm", "Second Samuel", "2Sa"),
    _b("1 Kings", "1 Kgs", "OT", 11, "1Kgs", "1 Ki", "1Ki", "First Kings"),
    _b("2 Kings", "2 Kgs", "OT", 12, "2Kgs", "2 Ki", "2Ki", "Second Kings"),
    _b(
        "1 Chronicles",
        "1 Chr",
        "OT",
    ...
    _b("Joel", "Joel", "OT", 29, "Jl"),
    _b("Amos", "Amos", "OT", 30, "Am"),
    _b("Obadiah", "Obad", "OT", 31, "Ob"),
    ...
    # ---- New Testament -----------------------------------------------------
    _b("Matthew", "Matt", "NT", 40, "Mt"),
    _b("Mark", "Mark", "NT", 41, "Mk", "Mrk"),
    _b("Luke", "Luke", "NT", 42, "Lk", "Luk"),
    _b("John", "John", "NT", 43, "Jn", "Jhn"),
    ...
    _b("Philippians", "Phil", "NT", 50, "Php", "Pp"),
    ...
    _b("1 Timothy", "1 Tim", "NT", 54, "1Tim", "1 Ti", "1Ti", "First Timothy"),
    _b("2 Timothy", "2 Tim", "NT", 55, "2Tim", "2 Ti", "2Ti", "Second Timothy"),
    _b("Titus", "Titus", "NT", 56, "Ti", "Tit"),
    _b("Philemon", "Phlm", "NT", 57, "Phm", "Pm"),
    _b("Hebrews", "Heb", "NT", 58, "He"),
    _b("James", "Jas", "NT", 59, "Jm"),
    _b("1 Peter", "1 Pet", "NT", 60, "1Pet", "1 Pe", "1Pe", "First Peter"),
    _b("2 Peter", "2 Pet", "NT", 61, "2Pet", "2 Pe", "2Pe", "Second Peter"),
    _b("1 John", "1 John", "NT", 62, "1Jn", "1 Jn", "1Jo", "1 Jo", "First John"),
    _b("2 John", "2 John", "NT", 63, "2Jn", "2 Jn", "2Jo", "2 Jo", "Second John"),
    _b("3 John", "3 John", "NT", 64, "3Jn", "3 Jn", "3Jo", "3 Jo", "Third John"),
